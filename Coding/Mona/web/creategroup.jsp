...
<div style="position:absolute; left:750px; top:280px"> </div>
 ...
 <div style="position:absolute; left:240px; top:250px"> 
      ...
      <h1 class="style9"><font size="4"><a href="ttp.jsp" class="style9">Group Manager</a> Registration</font></h1>
			<br>
			<p align="center">
...
<form  method="post" name="form" onsubmit="" action="creategroupmanager.jsp">
