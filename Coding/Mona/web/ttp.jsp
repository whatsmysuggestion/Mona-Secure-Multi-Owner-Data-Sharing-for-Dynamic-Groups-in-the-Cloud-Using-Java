...
<ul id="sidebarmenu1">
 ...
 <div style="position:absolute; left:240px; top:250px"> 
      <h1><font size="4"><a href="ttp.jsp">Group Manager</a> Login</font><br>
        <br>
</h1>
			<fieldset style="border: 2px #3399FF solid;">
      <legend><span class="style7"><font size="4"><strong>Login</strong><strong></strong></font><font size="4"><strong></strong></font></span></legend>


<table width="366" align="center">
 <form action="ttplogin.jsp" method="post" name="form" class="style7" onsubmit="return validation();">
<tr align="center">
            <td width="163" height="46" class="paragraping"><font size="3" >UserId</font></td>
<td width="191" class="fielditem"><input  name="email" type="text"  ></td>
</tr>


<tr align="center">
            <td width="163" height="51" class="paragraping"><font size="3">Password</font></td>
<td width="191" class="fielditem"><input name="pass" type="text" value="" /></td>
</tr>
<tr align="center">
<td></td>
...
<br><br>
      <p align="right"><font color="#000000" size="3"><strong><a href="register.jsp"></a></strong></font></p>
  </div>
  </div>                                
