...
<ul id="sidebarmenu1">
 ...
 <div style="position:absolute; left:251px; top:272px; width: 797px; height: 305px;"> 
  <h1><a href="viewuserreg.jsp" class="style6">View Medical Details</a></h1>
  <br><br>
 <fieldset style="border: 2px #3399FF solid;">
       <legend><font color="#3399FF" size="4"><strong>View</strong></font></legend>
<table width="794" height="105">
  <tr bgcolor="#3399FF"> 
          <td width="104" height="42" bgcolor="#3399FF"><div align="center"><font size="3">Id</font></div></td>
          <td width="139" height="42" bgcolor="#3399FF"><div align="center"><font size="3">Name</font></div></td>
          <td width="179" height="42"><div align="center"><font size="3">Age</font></div></td>
          <td width="152" height="42"><div align="center"><font size="3">Gender</font></div></td>
		  <td width="152" height="42"><div align="center"><font size="3">Email</font></div></td>
		  <td width="152" height="42"><div align="center"><font size="3">Phone</font></div></td>
		  <td width="152" height="42"><div align="center"><font size="3">Date</font></div></td>
...
<% 
	...
	Statement st = null;
	ResultSet rs = null;
	String id=null,name=null,age=null,gender=null, email=null,phone=null,date =null;
	...
	<tr>
	      <td height="40"><font size="3"> <%=id%></font></td>
	<td height="40"><font size="3"> <%=name%></font></td>
	<td height="40"><font size="3"> <%=age%></font></td>
	<td height="40"><font size="3"> <%=gender%></font></td>
	<td height="40"><font size="3"> <%=email%></font></td>
	<td height="40"><font size="3"> <%=phone%></font></td>
	<td height="40"><font size="3"> <%=date%></font></td>
