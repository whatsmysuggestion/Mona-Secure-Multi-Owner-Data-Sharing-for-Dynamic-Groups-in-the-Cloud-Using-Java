...
<% 
  ...
  String domain = request.getQueryString();
	...
	try{
		...
		String str1="select distinct title from upload where domain='"+domain+"'";
...
<div style="position:absolute; left:30px; top:20px"><img src="images/1.png" width="202" height="142"> </div>
...
<form method="post" name="form" action="viewgraph2.jsp">
...
<td width="172" class="name"><select type="text"  name="title" ><option>--Select Title--</option>
<%
		while(rs1.next())
		{
		%>
