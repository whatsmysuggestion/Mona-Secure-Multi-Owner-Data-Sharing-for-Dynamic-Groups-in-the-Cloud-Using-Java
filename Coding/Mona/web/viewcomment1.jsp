...
<% 
  ...
  String type = request.getQueryString();
	...
	try{
		...
		String str1="select  rate from cmtcount where type='"+type+"'";
...
var c=document.form.rate.options[document.form.rate.selectedIndex].value;
var t=document.getElementById("type").value;
window.location="http://localhost:8080/Rankmodel2/viewcomment2.jsp?"+c;
...
<div style="position:absolute; left:30px; top:20px"><img src="images/1.png" width="210" height="139"> </div>
...
<tr>
<td width="163" height="46" class="paragraping"><font size="3">Types</font></td>
<td width="191" class="fielditem"><input id="type" name="type" value="<%=type%>">
		</td>
</tr> 
<tr>
            <td width="101" height="46" class="paragraping"><font size="3">Rating</font></td>
<td width="172" class="name"><select type="text"  name="rate" onChange="fu()">
<option value="--Select Rating--">---Select Rating--</option>
		<%
		while(rs1.next())
		{
		%>
				<option value="<%= rs1.getString("rate")%>"><%= rs1.getString("rate")%></option>
