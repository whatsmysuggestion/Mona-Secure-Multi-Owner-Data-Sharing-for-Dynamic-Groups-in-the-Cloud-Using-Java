 ...
 <div style="position:absolute; left:240px; top:250px"> 
      ...
      <h1 class="style9">&nbsp;</h1>
         ...
         <%
                                                       ...
                                                       {
                                                               out.println("<font color='red' size='+1'><blink>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Deleted Successfully !</blink></font>");
                                                       }
                                               %>   
      </p>         
<fieldset style="border: 2px #3399FF solid;">
      <legend class="style8"><font size="4">Delete</font></legend>

 
                  
<table width="366" align="center">
<form  method="post" name="form" onsubmit="" action="deletegroupmanager.jsp">


<tr>
<td width="172" height="3" bgcolor="#0066CC" class="style6">&nbsp;</td>
<td width="172" class="id">&nbsp;</td>
</tr>
<tr>
  <td width="172" height="36" bgcolor="#0066CC" class="style10">User Id </td>
  <td class="id"><label>
...
<tr>
<td></td>
<td><input type="submit" name="B1" class="button2" value="Delete">
