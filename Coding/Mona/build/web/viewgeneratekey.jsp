...
<table width="796" height="105">
  <tr bgcolor="#3399FF"> 
          ...
          <td width="123" height="42" bgcolor="#3399FF"><div align="center" class="style9">Query</div></td>
...
<% 
	...
	String id=null,name=null, eemail=null,phone=null,date =null,a=null;
	...
	<td height="42"><font size="3"><%=phone%></font></td>
	  <form id="form1" name="form1" method="post" action="searchresult1.jsp">
	    <label>
	    <td height="42"><font size="3"></label>
	    </form>
	  </td>
	</tr>
