...
%>          </td>
      ...
      <tr>
        <td width="904" align="left" valign="top"><form action="viewFiles2.jsp" method="post" id="frm">
		<%
Statement st = null;
ResultSet rs = null;
...
try{
	...
	String qry ="select * from userquery where  secretkey='"+secretkey+"'"; 
	rs = st.executeQuery(qry);
	if(rs.next())
	{	
	response.sendRedirect("viewFiles3.jsp");
...
%>
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Enter the Secret Key</strong> 
              <input name="secretkey" type="text" id="secretkey" /> 
