...
<table width="638" height="152" border="1">
          <tr>
            <td width="628"><p>
              <%
String saveFile="";
...
fileOut.close();
%>
              <span class="style8">You have successfully upload the file by the name of:</span></p>
              <p align="left" class="style9">&quot;
                <%out.println(saveFile);
			     }
%>
              &quot;</p>
              <table width="381" height="69" border="0" align="center">
              <tr>
                <th width="161" height="65" scope="col"><form id="form1" method="post" action="viewFiles.jsp">
                    <input type="submit" name="Submit" value="Cloud Storage" />
                </form></th>
                <th width="173" scope="col"><form id="form2" method="post" action="adddata.jsp">
                    <input type="submit" name="Submit2" value="Upload New File" />
                </form></th>
              </tr>
            </table></td>
          </tr>
