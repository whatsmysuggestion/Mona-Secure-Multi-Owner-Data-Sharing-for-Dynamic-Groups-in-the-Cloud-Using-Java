...
<% 
	...
	try{
		...
		String str1="select distinct type from cmtcount";
...
var c=document.form.type.options[document.form.type.selectedIndex].value;
window.location="http://localhost:8080/Rankmodel2/viewcomment1.jsp?"+c;
...
<div style="position:absolute; left:-37px; top:19px; width: 254px;"><img src="images/1.png" width="237" height="144" /> </div>
...
<td width="191" class="fielditem"><select name="type" onChange="fu()">
...
<td width="172" class="name"><select type="text"  name="rate">
