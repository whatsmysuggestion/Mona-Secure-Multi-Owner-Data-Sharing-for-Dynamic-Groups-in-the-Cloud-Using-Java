...
<table width="794" height="105">
  <tr bgcolor="#3399FF"> 
          <td width="104" height="42" bgcolor="#3399FF"><div align="center"><font size="3">Title</font></div></td>
          <td width="139" height="42" bgcolor="#3399FF"><div align="center"><font size="3">MinValue</font></div></td>
          <td width="179" height="42"><div align="center"><font size="3">MaxValue</font></div></td>
          <td width="152" height="42"><div align="center"><font size="3">Description</font></div></td>
		  <td width="152" height="42"><div align="center"><font size="3">Related Posts</font></div></td>
</tr>
<% 
	...
	<td width="196" height="42"><form id="form1" name="form1" method="post" action="comments.jsp">
	  <label>
	  <input type="submit" name="Submit" id=<%=id%> value="View"/>
	  </label>
